...
function About() {
    return(
        <div className='main'>
            <div className='color-top'/>{/*COLOR TOP */}
            <div className='flexClass'>
                <div className="color-left" />{/*COLOR LEFT */}
